class _AffirmationHighlighter extends StatelessWidget {
  final String target;
  final String spokenPartial;
  final TextStyle? textStyle;

  const _AffirmationHighlighter({
    super.key,
  ...
  Widget build(BuildContext context) {
    final tgtNorm = _TextAlignment.normalize(target);
    final spkNorm = _TextAlignment.normalize(spokenPartial);

    // allow off-by-one space drifts
    final k = _TextAlignment.prefixMatchLen(tgtNorm, spkNorm);
